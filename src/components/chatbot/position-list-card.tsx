...
interface PositionListCardProps {
  positions: Position[];
}

export function PositionListCard({ positions }: PositionListCardProps) {
  return (
      ...
      <CardContent className="p-6">
        {positions.length === 0 ? (
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold mb-2">Không có vị trí nào</h3>
            <p className="text-sm text-muted-foreground">
              Hiện tại chưa có vị trí nào được tạo.
            </p>
          </div>
        ) : (
